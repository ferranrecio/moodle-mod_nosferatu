...
export const eventTypes = {
     ...
     */
    modNosferatuStateUpdated: 'mod_nosferatu/stateUpdated',
};
 ...
 */
export const notifyModNosferatuStateUpdated = (detail, container) => {
    return dispatchEvent(eventTypes.modNosferatuStateUpdated, detail, container);
};
